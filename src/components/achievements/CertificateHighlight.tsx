    ...
    <div className="mt-16 max-w-3xl mx-auto glass-card rounded-xl p-8">
      <div className="flex flex-col md:flex-row items-center">
        <div className="mb-6 md:mb-0 md:mr-6 relative">
          <div className="h-20 w-20 rounded-full bg-premium-amber/20 flex items-center justify-center relative overflow-hidden shadow-lg shadow-premium-amber/20">
            <Award className="h-10 w-10 text-premium-amber relative z-10" />
            {/* Animated background glow */}
            <div className="absolute inset-0 bg-gradient-to-br from-premium-amber/30 to-transparent animate-pulse-slow"></div>
          </div>

          {/* Animated rings */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full border border-premium-amber/30 animate-ping-slow opacity-70"></div>
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-28 h-28 rounded-full border border-premium-amber/20 animate-ping-slower opacity-50"></div>
        </div>
        <div>
